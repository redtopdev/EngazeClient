...
import com.redtop.engaze.utils.PlaceDetailsJSONParser;
import com.redtop.engaze.utils.PlaceJSONParser;
...
public class PlaceProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.redtop.engaze.service.PlaceProvider";
    ...
    String mKey = "AIzaSyA1XY_dE0OkxWWYGJZuXRAjFZi5ZEyeEYo";
...
//        String parameters = reference+"&"+sensor+"&"+mKey;
        String parameters = "key="+mKey+"&libraries=null";
    ...
    private String getPlacesUrl(String qry){
       ...
       // String parameters = qry+"&"+types+"&"+sensor+"&key="+mKey;
        String parameters = qry +"&key="+mKey;
